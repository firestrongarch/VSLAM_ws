...
class Kitti_Odom(Node):
    def __init__(self):
        ...
        left_img_topic_info = rosbag2_py._storage.TopicMetadata(id=0,name='/cam0/image_raw', type='sensor_msgs/msg/Image', serialization_format='cdr')
        right_img_topic_info = rosbag2_py._storage.TopicMetadata(id=1,name='/cam1/image_raw', type='sensor_msgs/msg/Image', serialization_format='cdr')
