...
Tracking::Tracking(System *pSys, ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer,
    Atlas *pAtlas, KeyFrameDatabase* pKFDB, const std::string &strSettingPath, const int sensor, Settings* settings, const std::string &_nameSeq)
...
void Tracking::UpdateLastFrame()
{
    ...
    // We std::sort points according to their measured depth by the stereo/RGB-D sensor
...
void Tracking::CreateNewKeyFrame()
{
    ...
    if(mSensor!=System::MONOCULAR && mSensor != System::IMU_MONOCULAR) // TODO check if incluide imu_stereo
    {
        ...
        // We std::sort points by the measured depth by the stereo/RGBD sensor.
...
void Tracking::UpdateFrameIMU(const float s, const IMU::Bias &b, KeyFrame* pCurrentKeyFrame)
{
    ...
    std::list<bool>::iterator lbL = mlbLost.begin();  // 对应帧是否跟踪丢失
...
void Tracking::SaveSubTrajectory(std::string strNameFile_frames, std::string strNameFile_kf, std::string strFolder)
{
    mpSystem->SaveTrajectoryEuRoC(strFolder + strNameFile_frames);
    //mpSystem->SaveKeyFrameTrajectoryEuRoC(strFolder + strNameFile_kf);
}

void Tracking::SaveSubTrajectory(std::string strNameFile_frames, std::string strNameFile_kf, Map* pMap)
{
