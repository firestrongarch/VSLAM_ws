...
void SlamManager::writeResults()
{
    ...
    Logger::writeTrajectory("output/ov2slam_traj.txt");
    Logger::writeTrajectoryKITTI("output/ov2slam_traj_kitti.txt");
    ...
    Logger::writeKfsTrajectory("output/ov2slam_kfs_traj.txt");
    ...
    if( pslamstate_->do_full_ba_ ) 
    {
        ...
        Logger::writeKfsTrajectory("output/ov2slam_fullba_kfs_traj.txt");
    }
...
void SlamManager::writeFullTrajectoryLC()
{
    ...
    std::ofstream f;
    std::string filename = "output/ov2slam_full_traj_wlc.txt";
